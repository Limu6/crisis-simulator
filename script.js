...
`;
    ...
    try {
        ...
        console.warn("Explanation JSON parse error:", err);
    }
...
`;
    ...
    try {
        ...
        if (
            ...
            typeof parsed.impact !== "undefined" &&
        ...
        console.warn("Outcome JSON parse error:", err);
    }
...
window.startNewCrisis = startNewCrisis;
...
async function callAI(prompt) {
    ...
    // If rate-limited or any other error → return empty string immediately
    if (!response.ok) {
...
document.getElementById("continueBtn").onclick = startNewCrisis;